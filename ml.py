...
attrribute =("""Attribute Information
age: age in years
...
def ml():
    st.header("Predication Section")
    
    st.markdown(attrribute)
    ...
    with col2:
        ...
        blood_sugar = st.radio("Your blood sugar value is", ["lower than 120mg/ml", 'greater than 120mg/ml'])
    ...
    with st.expander("Your selected options"):
		...
		"cholestrol":cholestrol, "blood_sugar":blood_sugar, "rest_ecg":rest_ecg,
    ...
    with st.expander("Prediction Result"):
        ...
        if prediction == 1:
            #color = st.color_picker('Red', '#fc000d')
            ...
            #color1 = st.color_picker('Green', '#0eeb45')
            st.warning("Negative Risk!! No need to worry")
